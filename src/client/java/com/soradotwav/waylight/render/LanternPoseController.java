...
public final class LanternPoseController {
	...
	private static final float PITCH_ACCELERATION_SCALE = 104.0F;
	private static final float ROLL_ACCELERATION_SCALE = 118.0F;
	private static final float FALL_PITCH_BIAS_SCALE = 130.0F;
	private static final float MAX_FALL_PITCH_TARGET = 84.0F;
	private static final float FALL_PITCH_STIFFNESS = 0.16F;
	private static final float TURN_SCALE = 0.22F;
	private static final float SPRINT_MOTION_MULTIPLIER = 1.1F;
	private static final float CROUCH_MOTION_MULTIPLIER = 0.65F;
	private static final float CROUCH_DAMPING_BONUS = 0.08F;
	private static final float JUMP_PITCH_IMPULSE = -7.5F;

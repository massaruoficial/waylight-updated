...
public final class LanternViewProjector {
	...
	public FirstPersonProjection projectHandLeft(LanternRig rig, FirstPersonHandMotionMode motionMode) {
		LanternTransform transform = rig.transform();
		float translateXDelta = motionMode == FirstPersonHandMotionMode.STATIC ? 0.0F : transform.translateX() - HAND_LEFT_BASE_TRANSLATE_X;
		float translateYDelta = motionMode == FirstPersonHandMotionMode.STATIC ? 0.0F : transform.translateY() - HAND_LEFT_BASE_TRANSLATE_Y;
		float translateZDelta = motionMode == FirstPersonHandMotionMode.STATIC ? 0.0F : transform.translateZ() - HAND_LEFT_BASE_TRANSLATE_Z;
		float rotateXDelta = motionMode == FirstPersonHandMotionMode.STATIC ? 0.0F : transform.rotateX() - HAND_LEFT_BASE_ROT_X;
		float rotateYDelta = motionMode == FirstPersonHandMotionMode.STATIC ? 0.0F : transform.rotateY() - HAND_LEFT_BASE_ROT_Y;
		float rotateZDelta = motionMode == FirstPersonHandMotionMode.STATIC ? 0.0F : transform.rotateZ() - HAND_LEFT_BASE_ROT_Z;
